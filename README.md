# Lógica de Programação - Lista 01 ☕

Repositório destinado à resolução da primeira lista de exercícios da disciplina de Lógica de Programação, ministrada pelo Prof. Gomide no curso de Engenharia de Computação (IF Goiano).
...
* **Exercício 01:** Leitura de Strings. O algoritmo recebe o nome e o sobrenome do usuário separadamente e imprime o nome completo concatenado.
